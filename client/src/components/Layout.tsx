...
const LogoMark = () => (
  <img src="/favicon.svg" width={28} height={28} alt="Documents" className="shrink-0" />
)
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2.5 group" style={{ textDecoration: 'none' }}>
            <LogoMark />
            <span className="text-xl font-extrabold tracking-tight gradient-text select-none">Documents</span>
          </Link>
